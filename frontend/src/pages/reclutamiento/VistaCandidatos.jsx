...
const VistaCandidatos = () => {
    ...
    const [nuevoCandidato, setNuevoCandidato] = useState({
        vacante: '', nombre_completo: '', correo: '', telefono: '', zona_ubicacion: ''
    });
                                    ...
                                    <tr key={candidato.id} style={{ borderBottom: '1px solid #F1F5F9' }}>
                                        <td style={{ padding: '16px' }}>
                                            ...
                                            <div style={{ display: 'flex', alignItems: 'center', gap: '4px', color: '#64748B', fontSize: '13px' }}>
                                                <MapPin size={14} /> {candidato.zona_ubicacion || 'Sin zona registrada'}
                                            </div>
                                        </td>
                                        <td style={{ padding: '16px' }}>
                ...
                <div style={{ position: 'fixed', top: 0, left: 0, width: '100%', height: '100%', backgroundColor: 'rgba(0,0,0,0.5)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1000 }}>
                    <div style={{ backgroundColor: 'white', padding: '32px', borderRadius: '16px', width: '100%', maxWidth: '500px', boxShadow: '0 20px 25px -5px rgba(0,0,0,0.1)' }}>
                        ...
                        <form onSubmit={handleCrearCandidato} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                            ...
                            <div>
                                <label style={{ display: 'block', fontSize: '13px', color: '#64748B', fontWeight: '600', marginBottom: '6px' }}>Zona de Ubicación *</label>
                                <input required value={nuevoCandidato.zona_ubicacion} onChange={e => setNuevoCandidato({...nuevoCandidato, zona_ubicacion: e.target.value})} type="text" style={{ width: '100%', padding: '10px', borderRadius: '8px', border: '1px solid #E2E8F0', boxSizing: 'border-box' }} placeholder="Ej. Norte de la ciudad, a 30 mins" />
                            </div>
