...
- **DOCUMENTACIÓN VIVA EN REPOSITORIO (WALKTHROUGHS)**: El usuario utiliza Obsidian como su Segundo Cerebro. **NUNCA dejes los Walkthroughs solo como artefactos temporales**. Al finalizar cualquier tarea significativa, DEBES escribir o copiar físicamente el archivo Markdown directamente dentro de la carpeta docs/ correspondiente en el repositorio (ej. docs/cotizador/2026-08-20_Walkthrough.md) usando las herramientas de escritura de archivos o bash. Asegúrate de incluir la fecha de hoy al inicio del nombre del archivo y dentro del contenido, y finalmente hacer un git commit y git push para respaldarlos.

- **MODALES PERSONALIZADOS**: Prohibido usar window.confirm o alert nativos. Siempre dise�ar e implementar Modales (Dialogs) personalizados en React con la misma paleta de colores y UX corporativa del sistema.
